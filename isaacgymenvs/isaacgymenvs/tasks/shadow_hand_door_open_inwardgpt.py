...
class ShadowHandDoorOpenInwardGPT(VecTask):
    """
    This class corresponds to the DoorOpenInward task with GPT/MLP reward model.
    Uses a neural network reward model instead of the ground truth reward function.
    """
    ...
    def compute_reward(self, actions):
        """
        Compute the reward using MLP reward model. Use compute_success for tracking ground truth metrics.
        """
        # Use MLP reward model for training reward
...
def compute_reward(
    ...
    """
    Compute reward using the MLP reward model.
    """
    reward = mlp_reward_model(obs_buf).squeeze(-1)
    return reward, {}
